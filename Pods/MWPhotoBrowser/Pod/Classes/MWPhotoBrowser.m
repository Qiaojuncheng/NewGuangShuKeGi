...
- (void)viewDidLoad {
    ...
    saveButton.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.4];
    saveButton.titleLabel.font = [UIFont systemFontOfSize:15];
    [saveButton setTitle:@"保存到本地相册" forState:UIControlStateNormal];
    [saveButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    saveButton.frame = CGRectMake(0, CGRectGetMaxY(self.view.bounds)-44, CGRectGetWidth(self.view.bounds), 44);
    [saveButton addTarget:self action:@selector(saveButtonClick) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:saveButton];
    alertView = [[UIView alloc]initWithFrame:CGRectMake(CGRectGetMidX(self.view.bounds)-100, 100, 200, 30)];
    alertView.backgroundColor = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1];
    [self.view addSubview:alertView];
    alertView.alpha = 0;
    UILabel *alertLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 200, 30)];
    alertLabel.textAlignment = NSTextAlignmentCenter;
    alertLabel.textColor = [UIColor whiteColor];
    alertLabel.font = [UIFont systemFontOfSize:15];
    alertLabel.text = @"保存到相册成功";
...
-(void)saveButtonClick{
    ...
    UIImageWriteToSavedPhotosAlbum([UIImage imageWithData:[NSData dataWithContentsOfURL:photo.photoURL]], self, @selector(image:didFinishSavingWithError:contextInfo:), (__bridge void *)self);
